...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    const shortLink = `${import.meta.env.VITE_REACT_FRONT_END_URL}/s/${shortUrl}`;
    const displayShortLink = `${subDomain}/s/${shortUrl}`;
    ...
    const analyticsHandler = (shortCode) => {
      ...
      setAnalyticToggle(true);
    }

    useEffect(() => {
      if (!selectedUrl || !analyticToggle) {
        return;
      }
    ...
    }, [selectedUrl, analyticToggle, navigate, token]);
